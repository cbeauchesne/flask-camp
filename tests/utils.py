...
class ClientInterface:
    ...
    def create_user(self, name="user", email=None, password="password", extra_payload=None, expected_status=None):
        ...
        return self.put("/users", expected_status=expected_status, json=payload)
    ...
    def rename_user(self, user, name, comment="a comment", expected_status=None):
        user_id = _get_user_id(user)
